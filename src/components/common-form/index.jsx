    ...
    function renderFormElement(getCurrentFormControl, getFormData){
        ...
        switch (getCurrentFormControl.componentType) {
            case formElementTypes.INPUT:
                element = <CommonInput type={getCurrentFormControl.type} placeholder={getCurrentFormControl.placeholder}
                value={getFormData[getCurrentFormControl.name]} name={getCurrentFormControl.name}
